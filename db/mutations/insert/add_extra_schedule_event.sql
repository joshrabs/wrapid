...
DROP FUNCTION add_extra_schedule_event(DATE, VARCHAR(50), VARCHAR(100), VARCHAR(100), TIMESTAMP WITHOUT TIME ZONE, TIMESTAMP WITHOUT TIME ZONE, extra_schedule_event_scene_desc, extra_schedule_event_time_of_day);
 */
